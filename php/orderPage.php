<?php
    ...
    $product_id=base64_decode($_GET['product-id']);
    // echo $product_id;   
            ...
            <div class="order-details-page-container">
                <div class="order-details-container">
                    ...
                    <div class="cart-item">
                        ...
                        <?php 
                            $sql="select * from product_table join cart on cart.product_id=product_table.product_id where cart.product_id={$product_id} and cart.user_id={$_SESSION['user_id']} and product_table.is_deleted=0 and cart.is_deleted=0";
                            $result=mysqli_query($conn, $sql);
                            if(mysqli_num_rows($result)>0)
                            {
                        ...
                        <div class="cart-item-details-container">
                            <div class="cart-item-image-container">
                                <img src="/e-commerce/<?php echo $row['product_image'] ?>" alt="">
                            </div>
                ...
                <div class="cart-price-details-container">
                    ...
                    <div class="price-details-info-container">
                        <div class="price-info">
                            <div class="product-count">Price (1) items</div>
                            <div class="price-ammount">₹<?php echo $row['product_price']*$row['quantity'] ?></div>
                        </div>
                        ...
                        <div class="total-price-info">
                            ...
                            <div class="total-ammount">₹<?php echo $row['product_price']*$row['quantity'] ?></div>
                        </div>
                    </div>
                </div>
            ...
            $('#pay-now-button').click(function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        var custom_orderId = response.custom_order_id;
                        ...
                        var options = {
                            ...
                            handler: function(response) {
                                ...
                                console.log(razorpay_order_id, razorpay_payment_id, razorpay_signature, product_id, address_id);
                                console.log('Payment successful');
                                $('.loading-container').css('display', 'flex');
                                $.ajax({
                                    url: "storeOrderDetails.php",
                                    type: "POST",
                                    data: {razorpay_order_id: razorpay_order_id, razorpay_payment_id: razorpay_payment_id, custom_orderId: custom_orderId, address_id: address_id, product_id: product_id, payment_mode: 'online'},
                                    success: function(data)
                                    {
                                        ...
                                        if(data == 1)
                                        {
                                            ...
                                            window.open('/e-commerce/php/success.php?orderId='+custom_orderId, '_self');
                                        }
                                        else if(data == 0)
                                        {
                    ...
                    $.ajax({
                        ...
                        success: function(data)
                        {
                            ...
                            if(data.status==1)
                            {
                                console.log("Successfully ordered");
                                $('.loading-container').css('display', 'none');
                                window.open('/e-commerce/php/success.php?orderId='+data.custom_order_id, '_self');
                            }
