...
<div class="menu-bar-container">
            ...
            <div class="sub-menu-container">
                <div class="sub-menu-column-container">
                    ...
                    <div class="sub-menu-column">
                        ...
                        <div class="sub-menu-item">
                            <a href="#">Collapsible Wardrobes</a>
                        </div>
                        <div class="sub-menu-item">
                            <a href="#">Blankets</a>
                        </div>
                        ...
                        <div class="sub-menu-item">
                            <a href="#">Kitchen & Table Linen</a>
                        </div>
                        <div class="sub-menu-item">
                            <a href="#">Floor Coverings</a>
                        </div>
    ...
    if(isset($_SESSION['user_id']) && isset($_SESSION['name']) && isset($_SESSION['email']) && isset($_SESSION['mobile']) && isset($_SESSION['user_type']))
    {
        ...
        <div class="menu-item wishlist-menu">
            <a href="#">
                <i class="fa-solid fa-heart">
                    <div class="wishlist-counter-container">
        ...
        <div class="menu-item logout-menu">
    ...
    {
        $output .='
            <div class="menu-item login-menu">
